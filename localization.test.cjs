...
test('every active native UI message and server or bridge failure has a translation',()=>{
 for(const file of ['InzoiSocial/lua/B1/UI/Pages/OnlinePage.lua','InzoiSocial/lua/B1/UI/SocialAppView.lua','InzoiSocial/lua/B1/Localization.lua','InzoiSocial/lua/B1/Online/Controller.lua','InzoiSocial/lua/B1/Online/Transport.lua','InzoiSocial/lua/B1/Game/PhotoFlow.lua','InzoiSocial/ui/OnlineBridge/app.js','server/src/app.cjs','server/src/steam.cjs']){
