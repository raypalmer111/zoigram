# Zoigram 0.6.0 — source and build instructions

Patch 0.6 (client 0.6.0, server 0.18.0) adds private saved posts and comment notifications. The phone interface automatically follows the game language and supports English, Russian, French, Korean, German and Simplified Chinese. Send location in direct messages displays “Coming soon”; no location is collected or transmitted. Account pages in the browser remain in English. Existing search, profile grids, caption editing and verified badges are retained.
