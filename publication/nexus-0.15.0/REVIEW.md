# Zoigram 0.15.0 — source and build instructions

Client 0.15.0 displays verified account badges supplied by Zoigram server 0.16.0. The server retains login/password authentication without Steam or email. Browser account pages use English; the phone interface supports English, Russian, French and Korean.
