# Zoigram 0.5.0 — source and build instructions

Patch 0.5 (client 0.5.0) adds player search, three-column profile photo grids and editing your own post captions. It requires Zoigram server 0.17.0 and retains verified account badges. The server retains login/password authentication without Steam or email. Browser account pages use English; the phone interface supports English, Russian, French and Korean.
...
The result is review-output/InzoiSocial_YV6DPJ. On Windows, this command also creates separate standard ZIPs:
